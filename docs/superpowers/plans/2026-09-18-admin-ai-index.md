...
| 顺序 | 计划 | 状态 | 独立交付物 |
|---|---|---|---|
| 5.1A | [产品与数据契约](2026-09-18-admin-ai-5.1a-product-contract.md) | 待实施 | 冻结产品边界、隐私策略、接口和数据结构；只改文档 |
| 5.1B | [模式目录后端](2026-09-18-admin-ai-5.1b-mode-catalog-backend.md) | 待实施 | 模式、提示词版本、CRUD、复制、启停、排序和回滚 API |
| 5.1C | [模式设置页](2026-09-18-admin-ai-5.1c-mode-settings-ui.md) | 待实施 | 管理端“AI 设置”页面和完整浏览器回归 |
| 5.1D | [转换运行时](2026-09-18-admin-ai-5.1d-transform-runtime.md) | 待实施 | 能力查询、DeepSeek 适配、转换接口、限流、超时和脱敏日志 |
| 5.1E | [文章 AI 抽屉](2026-09-18-admin-ai-5.1e-editor-drawer.md) | 待实施 | 正文带入、执行、取消、结果编辑/复制和本地存储 |
| 5.1F | [质量与发布](2026-09-18-admin-ai-5.1f-quality-release.md) | 待实施 | 假供应商回归、受控真实评测、文档收口和发布门禁 |
