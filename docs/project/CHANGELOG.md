...
- Markdown 链接和图片仅允许 HTTP、HTTPS、Mailto 与相对 URL，阻止 `javascript:`、`data:` 等可执行协议。
- 验证结果：前端 40 tests、生产构建通过；使用本地 mock API 完成桌面与 390px 分类、标签、站点设置、改密页和公开标题刷新检查。实际密码轮换未在浏览器提交。
