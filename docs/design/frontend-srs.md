...
| 页面 | 路由 | 目标能力 | 当前状态 |
|---|---|---|---|
| 首页 | `/` | 站点信息、最新文章、分类入口 | 占位 |
| 分类浏览 | `/library` | 分类、标签筛选和分页 | 占位 |
| 搜索 | `/search` | URL 同步、关键词搜索、429 提示 | 占位 |
| 文章详情 | `/post/:slug` | Markdown、代码高亮、元信息 | 占位 |
| About | `/about` | 读取并渲染 `about_page` | 占位 |
| Project | `/project` | 读取并渲染 `project_page` | 占位 |
| 在线编辑器 | `/editor` | 导入、编辑、预览、下载 `.md` | 占位 |
| 404 | 任意未匹配路由 | 错误提示和返回首页 | 基础实现 |
